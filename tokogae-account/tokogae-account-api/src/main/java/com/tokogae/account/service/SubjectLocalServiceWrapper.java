...
public class SubjectLocalServiceWrapper
	...
	public com.tokogae.account.model.Subject addSubject(
		com.tokogae.account.model.Subject subject) {
	...
	public com.liferay.portal.kernel.model.PersistedModel createPersistedModel(
		...
		return _subjectLocalService.createPersistedModel(primaryKeyObj);
	}
	 ...
	 */
	@Override
	public com.tokogae.account.model.Subject createSubject(long subjectId) {
	 ...
	 */
	@Override
	public com.tokogae.account.model.Subject deleteSubject(
		com.tokogae.account.model.Subject subject) {
	...
	public <T> T dslQuery(com.liferay.petra.sql.dsl.query.DSLQuery dslQuery) {
		return _subjectLocalService.dslQuery(dslQuery);
	}
	...
	public int dslQueryCount(
		...
		return _subjectLocalService.dslQueryCount(dslQuery);
	}
	...
	@Override
	public com.tokogae.account.model.Subject fetchSubject(long subjectId) {
	...
	public BasePersistence<?> getBasePersistence() {
		return _subjectLocalService.getBasePersistence();
	}
