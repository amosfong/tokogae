...
/**
 * The base model implementation for the Subject service. Represents a row in the &quot;Subject&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
...
public class SubjectModelImpl
	...
	public static final Object[][] TABLE_COLUMNS = {
		...
		{"displayName", Types.VARCHAR}, {"male", Types.BOOLEAN},
	...
	public static final String TABLE_SQL_CREATE =
		"create table Subject (mvccVersion LONG default 0 not null,subjectId LONG not null primary key,companyId LONG,userId LONG,createDate DATE null,modifiedDate DATE null,firstName VARCHAR(75) null,lastName VARCHAR(75) null,displayName VARCHAR(75) null,male BOOLEAN,birthday DATE null)";

	public static final String TABLE_SQL_DROP = "drop table Subject";

	public static final String ORDER_BY_JPQL =
		" ORDER BY subject.subjectId ASC";

	public static final String ORDER_BY_SQL = " ORDER BY Subject.subjectId ASC";
	 ...
	 */
	@Deprecated
	public static final long SUBJECTID_COLUMN_BITMASK = 1L;
	...
	private static class AttributeGetterFunctionsHolder {
		...
		static {
			...
			attributeGetterFunctions.put("male", Subject::getMale);
	...
	private static class AttributeSetterBiConsumersHolder {
		...
		static {
			...
			attributeSetterBiConsumers.put(
				"male", (BiConsumer<Subject, Boolean>)Subject::setMale);
			attributeSetterBiConsumers.put(
	...
	public Subject cloneWithOriginalValues() {
		...
		subjectImpl.setMale(this.<Boolean>getColumnOriginalValue("male"));
