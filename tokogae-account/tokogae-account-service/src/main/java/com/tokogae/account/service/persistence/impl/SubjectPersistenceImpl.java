...
import com.tokogae.account.service.persistence.SubjectUtil;
import com.tokogae.account.service.persistence.impl.constants.TOKOGAEPersistenceConstants;
...
public class SubjectPersistenceImpl
	...
	public SubjectPersistenceImpl() {
		...
		setTable(SubjectTable.INSTANCE);
	}
	...
	public void clearCache() {
		...
		finderCache.clearCache(SubjectImpl.class);
	}
	...
	public void clearCache(Subject subject) {
		entityCache.removeResult(SubjectImpl.class, subject);
	}
	...
	public void clearCache(Set<Serializable> primaryKeys) {
		...
		for (Serializable primaryKey : primaryKeys) {
			entityCache.removeResult(SubjectImpl.class, primaryKey);
		}
	}
	...
	public Subject updateImpl(Subject subject) {
		...
		entityCache.putResult(SubjectImpl.class, subjectModelImpl, false, true);
	...
	public void activate() {
		...
		SubjectUtil.setPersistence(this);
	}

	@Deactivate
	public void deactivate() {
		SubjectUtil.setPersistence(null);
	...
	@Override
	@Reference(
		target = TOKOGAEPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = TOKOGAEPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
