...
/**
 * Provides the local service utility for Symptom. This utility wraps
 * <code>com.tokogae.data.event.service.impl.SymptomLocalServiceImpl</code> and
 ...
 * @generated
 */
public class SymptomLocalServiceUtil {
	 ...
	 */
	public static Symptom addSymptom(Symptom symptom) {
		return getService().addSymptom(symptom);
	}
	 ...
	 */
	public static Symptom createSymptom(long symptomId) {
		return getService().createSymptom(symptomId);
	}
	 ...
	 * @return the symptom that was removed
	 */
	public static Symptom deleteSymptom(Symptom symptom) {
		return getService().deleteSymptom(symptom);
	}
	...
	public static Symptom fetchSymptom(long symptomId) {
		return getService().fetchSymptom(symptomId);
	}
	 ...
	 * @throws PortalException if a symptom with the primary key could not be found
	 */
	public static Symptom getSymptom(long symptomId) throws PortalException {
		return getService().getSymptom(symptomId);
	}
	 ...
	 */
	public static List<Symptom> getSymptoms(int start, int end) {
		return getService().getSymptoms(start, end);
	}
	 ...
	 */
	public static int getSymptomsCount() {
		return getService().getSymptomsCount();
	}
	 ...
	 */
	public static Symptom updateSymptom(Symptom symptom) {
		return getService().updateSymptom(symptom);
	}

	public static SymptomLocalService getService() {
		return _serviceSnapshot.get();
	}

	private static final Snapshot<SymptomLocalService> _serviceSnapshot =
		new Snapshot<>(
			SymptomLocalServiceUtil.class, SymptomLocalService.class);
